...
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = #CC241D/g' $PDIR/colors.ini
sed -i -e 's/shade2 = .*/shade2 = #D65D0E/g' $PDIR/colors.ini
sed -i -e 's/shade3 = .*/shade3 = #D79921/g' $PDIR/colors.ini
sed -i -e 's/shade4 = .*/shade4 = #98971A/g' $PDIR/colors.ini
sed -i -e 's/shade5 = .*/shade5 = #689D6A/g' $PDIR/colors.ini
sed -i -e 's/shade6 = .*/shade6 = #458588/g' $PDIR/colors.ini
sed -i -e 's/shade7 = .*/shade7 = #B16286/g' $PDIR/colors.ini
sed -i -e 's/shade8 = .*/shade8 = #a89984/g' $PDIR/colors.ini
sed -i -e 's/accent = .*/accent = #fabd2f/g' $PDIR/colors.ini
sed -i -e 's/bground = .*/bground = #1D2021/g' $PDIR/colors.ini
sed -i -e 's/modulefg = .*/modulefg = #ebdbb2/g' $PDIR/colors.ini
sed -i -e 's/modulefg-alt = .*/modulefg-alt = #fbf1c7/g' $PDIR/colors.ini
# Restarting polybar
$LAUNCH &
